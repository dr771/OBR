...
- **Reference audits are opt-in.** Do not run an AI/design audit (for example `impeccable detect`) on a reference unless the user explicitly asks for one. For a requested visual match, measure the named element directly.
