...
1. **Port next from the remaining ready reuse candidates:** `predictive-search-overlay`. (`cart-drawer-line-item-layout` done 2026-08-11; `wishlist-integration` shipped, live-verified, and archived 2026-08-12.)
